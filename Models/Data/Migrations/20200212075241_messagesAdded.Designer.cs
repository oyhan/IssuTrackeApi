...
namespace Asanobat.IssueTracker.Models.Data.Migrations
{
    ...
    [Migration("20200212075241_messagesAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asanobat.IssueTracker.Models.Entity.Message.MessageModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575", ConcurrencyStamp = "0f1806c1-6f68-4a5d-b2f7-2408c57c33de", Name = "Admin", NormalizedName = "ADMIN" }
                    );
                });
            ...
            modelBuilder.Entity("Asanobat.IssueTracker.Models.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575", AccessFailedCount = 0, ConcurrencyStamp = "b3112b41-542f-4064-af1e-1b772b7c71e3", Email = "admin@PooyanSystem.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "ADMIN@POOYANSYSTEM.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEC7t969CSJ8bYp05whUywgMV9tfzYoZCrZiJo6yijrdwUsLEru4JyxjNmIUeniGs7g==", PhoneNumberConfirmed = false, SecurityStamp = "", TwoFactorEnabled = false, UserName = "Admin" }
                    );
                });
            ...
            modelBuilder.Entity("Asanobat.IssueTracker.Models.Entity.Message.MessageModel", b =>
                {
                    ...
                    b.HasOne("Asanobat.IssueTracker.Models.Identity.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("Asanobat.IssueTracker.Models.Identity.ApplicationUser", "Sender")
                        .WithMany()
